...
@Path("/beneficiaires")
public class DocumentBeneficiaireEndpoint extends DocumentEndpoint {
    ...
    public Response searchDocumentAdherent(
        ...
        SearchFilteredDocsDto responseSearch = documentService.searchDocStarwebByBeneficiaire(sBenef, contexte, cmroc, envir, page, size, filters);
