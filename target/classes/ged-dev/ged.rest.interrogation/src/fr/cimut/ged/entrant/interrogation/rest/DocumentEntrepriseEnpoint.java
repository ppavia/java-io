...
@Path("/entreprises")
public class DocumentEntrepriseEnpoint extends DocumentEndpoint {

    @Path("/{id}/documents")
    @GET
    @Produces(javax.ws.rs.core.MediaType.APPLICATION_JSON)
    public Response searchDocumentEntreprise(
            @HeaderParam(AUTHORIZATION) String authKey,
            @PathParam(ID) Long idEntreprise,
        ...
        SearchFilteredDocsDto responseSearch = documentService.searchDocStarwebByEntreprise(idEntreprise, contexte, cmroc, envir, page, size, filters);
